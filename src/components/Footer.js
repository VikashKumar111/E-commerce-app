          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a href="tel:+91 9999999999" className="mt-3 d-block mb-1 text-white">+91 9999999999</a>
                <a href="mailto:bme@gmail.com" className="mt-2 d-block mb-0 text-white">bme@gmail.com</a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Edugyan
              </p>
            </div>
          </div>
        </div>
